...
{
    public class BankRevalWrapperCommUploadDashBoardController : Controller
    {
        ...
        public ActionResult GetReconciliationData()
        {
            ...
            BankRevalWrapperCommUploadDashBoardDAL objDAL = new BankRevalWrapperCommUploadDashBoardDAL();
            try
            {
        ...
        [HttpPost]
        public ActionResult GetReconUploadDataFileByHdrSeq([FromBody]BankRevalWrapperCommUploadDashBoardBO objBO)
        {
            string res = string.Empty;
            string FilePath = "";
            BankRevalWrapperCommUploadDashBoardDAL objDAL = new BankRevalWrapperCommUploadDashBoardDAL();
        ...
        [HttpPost]
        public ActionResult GetReconSuccessDataFileByHdrSeq([FromBody]BankRevalWrapperCommUploadDashBoardBO objBO)
        {
        ...
        [HttpPost]
        public ActionResult GetReconExceptionDataFileByHdrSeq([FromBody]BankRevalWrapperCommUploadDashBoardBO objBO)
        {
        ...
        //[HttpPost]
        //public ActionResult CancelReconciliationProcess([FromBody]BankRevalWrapperCommUploadDashBoardBO objBO)
        //{
        //    string res = string.Empty;
        //    BankRevalWrapperCommUploadDashBoardDAL objDAL = new BankRevalWrapperCommUploadDashBoardDAL();
        //    SessionBO objSessionBo = HttpContext.Session.GetObject<SessionBO>("UserSessionDetails");
        ...
        //public ActionResult ProcessReconciliationData([FromBody]BankRevalWrapperCommUploadDashBoardBO objBO)
        //{
        //    string res = string.Empty;
        //    BankRevalWrapperCommUploadDashBoardDAL objDAL = new BankRevalWrapperCommUploadDashBoardDAL();
        //    SessionBO objSessionBo = HttpContext.Session.GetObject<SessionBO>("UserSessionDetails");
        ...
        [HttpPost]
        public ActionResult SetFileName([FromBody] BankRevalWrapperCommUploadDashBoardBO objBO)
        {
