...
function bindData() {
    ...
    ExtendedAjaxCall('/RTGSReconciliationDashBoard/GetReconciliationData', null, 'GET', function (result) {
        console.log(result);
...
function DownloadReconUploadedData(hdrSeq, FileName) {
    if (FileName != null && FileName != "") {
        ...
        ExtendedAjaxCall('/RTGSReconciliationDashBoard/GetReconUploadDataFileByHdrSeq', objBO, 'POST', function (result) {
...
function DownloadReconExceptionData(hdrSeq, FileName) {
    ...
    if (FileName != null && FileName.trim() != "") {
        ...
        var objBO = { HdrSeq: hdrSeq };
        ExtendedAjaxCall('/RTGSReconciliationDashBoard/GetReconExceptionDataFileByHdrSeq', objBO, 'POST', function (result) {
...
function DownloadReconSuccessData(hdrSeq, FileName) {
    ...
    if (FileName != null && FileName.trim() != "") {
        ...
        var objBO = { HdrSeq: hdrSeq };
        ExtendedAjaxCall('/RTGSReconciliationDashBoard/GetReconSuccessDataFileByHdrSeq', objBO,  'POST', function (result) {
            if (result != null && result != '') {
...
function CancelProcess(hdrSeq) {
    if (confirm("Do you want to Cancel process?")) {
        ...
        var objBO = { HdrSeq: hdrSeq, HdrSequence: hdrSeq };
        ExtendedAjaxCall('/RTGSReconciliationDashBoard/CancelReconciliationProcess', objBO, 'POST', function (result) {
                if (result != null && result != '') {
...
function ProcessReconData(hdrSeq) {
    ...
    if (confirm("Do you want to process the reconciliation data?")) {
        ...
        ExtendedAjaxCall('/RTGSReconciliationDashBoard/ProcessReconciliationData', objBO, 'POST', function (result) {
                if (result != null && result != '') {
...
function DownloadFile(Filename) {
    ...
    ExtendedAjaxCall('/RTGSReconciliationDashBoard/SetFileName', objBO, 'POST', function (result) {
        console.log(result);
