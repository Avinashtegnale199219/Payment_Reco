...
$(document).ready(function () {
    $('#lblPageName').text('EP UTR RTGS REPORT');
    bindData();
});
...
function bindData() {
    ...
    ExtendedAjaxCall('/EP_UTR_RTGS_UploadReport/GetUTR_RTGS_UploadData', null, 'GET', function (result) {
        let html = '';
...
function DownloadReconUploadedData(hdrSeq, FileName) {
    ...
    if (filePath == null && filePath == "") {
        ...
        ExtendedAjaxCall('/EP_UTR_RTGS_UploadReport/ViewFile?HdrSeq=' + hdrSeq, null, 'POST', function (result) {
...
$("#btnExporttoExcel").click(function () {
    $("#tableRtgsUtrUpload").table2excel({
        filename: "EP_UTR_RTGS_UPLOAD.xls"
    });
});    