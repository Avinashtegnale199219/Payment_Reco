$(document).ready(function () {
    // $('#lblPageName').text('RTGS Reconciliation Dashboard');
    bindData();
});
...
function bindData() {
    ...
    ExtendedAjaxCall('/CMSCollectionReconciliationDashBoard/GetReconciliationData', null, 'GET', function (result) {
        console.log(result);
...
function DownloadReconUploadedData(hdrSeq, FileName) {
    ...
    if (FileName != null && FileName != "") {
        ...
        ExtendedAjaxCall('/CMSCollectionReconciliationDashBoard/GetReconUploadDataFileByHdrSeq', objBO, 'POST', function (result) {
            console.log(result);
...
function DownloadReconExceptionData(hdrSeq, FileName) {
    ...
    if (FileName != null && FileName.trim() != "") {
        ...
        var objBO = { HdrSeq: hdrSeq };
        ExtendedAjaxCall('/CMSCollectionReconciliationDashBoard/GetReconExceptionDataFileByHdrSeq', objBO, 'POST', function (result) {
...
function DownloadReconSuccessData(hdrSeq, FileName) {
    ...
    if (FileName != null && FileName.trim() != "") {
        ...
        var objBO = { HdrSeq: hdrSeq };
        ExtendedAjaxCall('/CMSCollectionReconciliationDashBoard/GetReconSuccessDataFileByHdrSeq', objBO, 'POST', function (result) {
            if (result != null && result != '') {
...
function CancelProcess(hdrSeq) {
    if (confirm("Do you want to Cancel process?")) {
        ...
        ExtendedAjaxCall('/CMSCollectionReconciliationDashBoard/CancelReconciliationProcess', objBO, 'POST', function (result) {
            if (result != null && result != '') {
...
function ProcessReconData(hdrSeq) {
    ...
    if (confirm("Do you want to process the reconciliation data?")) {
        ...
        //data.append("HdrSequence", hdrSeq);
        var objBO = { HdrSequence: hdrSeq };
        ExtendedAjaxCall('/CMSCollectionReconciliationDashBoard/ProcessReconciliationData', objBO, 'POST', function (result) {
            if (result != null && result != '') {
...
function DownloadFile(filename) {
    ...
    ExtendedAjaxCall('/CMSCollectionReconciliationDashBoard/SetFileName', objBO, 'POST', function (result) {
        console.log(result);
