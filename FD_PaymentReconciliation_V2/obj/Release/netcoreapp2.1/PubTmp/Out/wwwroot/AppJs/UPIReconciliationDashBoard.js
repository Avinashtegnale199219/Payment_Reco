$(document).ready(function () {
    $('#lblPageName').text('UPI Reconciliation Dashboard');
    bindData();
});
...
function bindData() {
    ...
    ExtendedAjaxCall('/UPIReconciliationDashBoard/GetReconciliationData', null, 'GET', function (result) {
        console.log(result);
...
function DownloadReconUploadedData(hdrSeq, FileName) {
    ...
    if (FileName != null && FileName != "") {
        ...
        ExtendedAjaxCall('/UPIReconciliationDashBoard/GetReconUploadDataFileByHdrSeq', objBO, 'POST', function (result) {
...
function DownloadReconExceptionData(hdrSeq, FileName) {
    ...
    if (FileName != null && FileName.trim() != "") {
        ...
        var objBO = { HdrSeq: hdrSeq };
        ExtendedAjaxCall('/UPIReconciliationDashBoard/GetReconExceptionDataFileByHdrSeq', objBO, 'POST', function (result) {
            console.log(result);
            if (result != null && result != '') {
...
function DownloadReconSuccessData(hdrSeq, FileName) {
    ...
    if (FileName != null && FileName.trim() != "") {
        ...
        ExtendedAjaxCall('/UPIReconciliationDashBoard/GetReconSuccessDataFileByHdrSeq', { "HdrSeq": hdrSeq }, 'POST', function (result) {
            if (result != null && result != '') {
...
function CancelProcess(hdrSeq) {
    if (confirm("Do you want to Cancel process?")) {
        ...
        ExtendedAjaxCall('/UPIReconciliationDashBoard/CancelReconciliationProcess',
...
function ProcessReconData(hdrSeq) {
    ...
    if (confirm("Do you want to process the reconciliation data?")) {
        ...
        //data.append("HdrSequence", hdrSeq);
        var objBO = { HdrSequence: hdrSeq };
        ExtendedAjaxCall('/UPIReconciliationDashBoard/ProcessReconciliationData',
            objBO, 'POST', function (result) {
                if (result != null && result != '') {
...
function DownloadFile(FileName) {
    ...
    ExtendedAjaxCall('/UPIReconciliationDashBoard/SetFileName', objBO, 'POST', function (result) {
