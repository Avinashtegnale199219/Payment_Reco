...
{
    public class CMSCollectionRecoProcessDashBoardDAL
    {
        private readonly string strConn;
        public CMSCollectionRecoProcessDashBoardDAL()
        {
        ...
        {
            return SqlHelper.ExecuteDataSet(strConn, CommandType.StoredProcedure, "usp_FD_CMS_Collection_RecoUpload_Data");
        }
        public DataSet GetReconUploadData(string HdrSeq)
        {
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@HdrSeq", HdrSeq);
            return SqlHelper.ExecuteDataSet(strConn, CommandType.StoredProcedure, "usp_FD_CMS_Collection_Reco_Upload_Data", param);
        }
        public Int32 UpdateReconHdrUploadedFileDetails(string HdrSeq, string FileName, string FilePath, SessionBO obj)
        {
            ...
            return SqlHelper.ExecuteNonQuery(strConn, CommandType.StoredProcedure, "usp_FD_CMS_Collection_Update_Hdr_Total_Upload_File_Details", param);
        }
        public DataSet GetReconExceptionData(string HdrSeq)
        {
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@HdrSeq", HdrSeq);
            return SqlHelper.ExecuteDataSet(strConn, CommandType.StoredProcedure, "usp_FD_CMS_Collection_Reco_Exception_Data", param);
        }
        public Int32 UpdateReconHdrExceptionFileDetails(string HdrSeq, string FileName, string FilePath, SessionBO obj)
        {
            ...
            param[4] = new SqlParameter("@UpdatedByUName", obj.Entity_Name);
            param[5] = new SqlParameter("@UpdatedIP", obj.CreatedIP);
            return SqlHelper.ExecuteNonQuery(strConn, CommandType.StoredProcedure, "usp_FD_CMS_Collection_Update_Hdr_Exception_File_Details", param);
        }
        public DataSet GetReconSuccessData(string HdrSeq)
        {
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@HdrSeq", HdrSeq);
            return SqlHelper.ExecuteDataSet(strConn, CommandType.StoredProcedure, "usp_FD_CMS_Collection_Reco_Success_Data", param);
        }
        public Int32 UpdateReconHdrSuccessFileDetails(string HdrSeq, string FileName, string FilePath, SessionBO obj)
        {
            ...
            param[4] = new SqlParameter("@UpdatedByUName", obj.Entity_Name);
            param[5] = new SqlParameter("@UpdatedIP", obj.CreatedIP);
            return SqlHelper.ExecuteNonQuery(strConn, CommandType.StoredProcedure, "usp_FD_CMS_Collection_Update_Hdr_Success_File_Details", param);
        }
        public int CancelReconciliationProcess(string HdrSeq, SessionBO obj)
        {
            ...
            return SqlHelper.ExecuteNonQuery(strConn, CommandType.StoredProcedure, "usp_FD_CMS_Collection_Cancel_Reconciliation_Process", param);
        }
        public int ProcessReconciliationData(string HdrSeq, SessionBO obj)
        {
            ...
            param[2] = new SqlParameter("@UpdatedByUName", obj.Entity_Name);
            param[3] = new SqlParameter("@UpdatedIP", obj.CreatedIP);
            return SqlHelper.ExecuteNonQuery(strConn, CommandType.StoredProcedure, "usp_FD_CMS_Collection_Process_Reconciliation_Data", param);
        }
    }
}
