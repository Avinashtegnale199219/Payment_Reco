...
{
    public class HDFCSoftFeedReconProcessDashBoardDAL
    {
        private readonly string ConStr_PaymentReco;
        public HDFCSoftFeedReconProcessDashBoardDAL()
        {
        ...
        {
            return SqlHelper.ExecuteDataSet(ConStr_PaymentReco, CommandType.StoredProcedure, "usp_FD_HDFCSoftFeed_RecoUpload_Data");
        }
        ...
        public DataSet GetReconSuccessData(string HdrSeq)
        {
            ...
            return SqlHelper.ExecuteDataSet(ConStr_PaymentReco, CommandType.StoredProcedure, "usp_FD_HDFCSoftFeed_Reco_Success_Data", param);
        }
        public DataSet GetReconUploadData(string HdrSeq)
        {
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@HdrSeq", HdrSeq);
            return SqlHelper.ExecuteDataSet(ConStr_PaymentReco, CommandType.StoredProcedure, "usp_FD_HDFCSoftFeed_Reco_Upload_Data", param);
        }
        public DataSet GetReconExceptionData(string HdrSeq)
        {
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@HdrSeq", HdrSeq);
            return SqlHelper.ExecuteDataSet(ConStr_PaymentReco, CommandType.StoredProcedure, "usp_FD_HDFCSoftFeed_Reco_Exception_Data", param);
        }
        ...
        public Int32 UpdateReconHdrUploadedFileDetails(string HdrSeq, string FileName, string FilePath, SessionBO obj)
        {
            ...
            return SqlHelper.ExecuteNonQuery(ConStr_PaymentReco, CommandType.StoredProcedure, "usp_FD_HDFCSoftFeed_Update_Hdr_Total_Upload_File_Details", param);
        }
        ...
        public Int32 UpdateReconHdrSuccessFileDetails(string HdrSeq, string FileName, string FilePath, SessionBO obj)
        {
            ...
            param[4] = new SqlParameter("@UpdatedByUName", obj.Entity_Name);
            param[5] = new SqlParameter("@UpdatedIP", obj.CreatedIP);
            return SqlHelper.ExecuteNonQuery(ConStr_PaymentReco, CommandType.StoredProcedure, "usp_FD_HDFCSoftFeed_Update_Hdr_Success_File_Details", param);
        }
        ...
        public Int32 UpdateReconHdrExceptionFileDetails(string HdrSeq, string FileName, string FilePath, SessionBO obj)
        {
            ...
            param[4] = new SqlParameter("@UpdatedByUName", obj.Entity_Name);
            param[5] = new SqlParameter("@UpdatedIP", obj.CreatedIP);
            return SqlHelper.ExecuteNonQuery(ConStr_PaymentReco, CommandType.StoredProcedure, "usp_FD_HDFCSoftFeed_Update_Hdr_Exception_File_Details", param);
        }
        ...
        public int CancelReconciliationProcess(string HdrSeq, SessionBO obj)
        {
            ...
            return SqlHelper.ExecuteNonQuery(ConStr_PaymentReco, CommandType.StoredProcedure, "usp_FD_HDFCSoftFeed_Cancel_Reconciliation_Process", param);
        }
        ...
        public int ProcessReconciliationData(string HdrSeq, SessionBO obj)
        {
            ...
            param[2] = new SqlParameter("@UpdatedByUName", obj.Entity_Name);
            param[3] = new SqlParameter("@UpdatedIP", obj.CreatedIP);
            return SqlHelper.ExecuteNonQuery(ConStr_PaymentReco, CommandType.StoredProcedure, "usp_FD_HDFCSoftFeed_Process_Reconciliation_Data", param);
        }
