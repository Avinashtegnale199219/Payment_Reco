...
namespace DMS_DOCUMENT_SERVICE
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://mfdms.com/Webservice/AddDocument.jws", ConfigurationName="DMS_DOCUMENT_SERVICE.AddDocument")]
    public interface AddDocument
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(Style=System.ServiceModel.OperationFormatStyle.Rpc, SupportFaults=true, Use=System.ServiceModel.OperationFormatUse.Encoded)]
        System.Threading.Tasks.Task<DMS_DOCUMENT_SERVICE.addDocumentResponse> addDocumentAsync(DMS_DOCUMENT_SERVICE.addDocumentRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.0.0")]
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    [System.ServiceModel.MessageContractAttribute(WrapperName="addDocumentResponse", WrapperNamespace="http://mfdms.com/Webservice/AddDocument.jws", IsWrapped=true)]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.0.0")]
    public interface AddDocumentChannel : DMS_DOCUMENT_SERVICE.AddDocument, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.0.0")]
    public partial class AddDocumentClient : System.ServiceModel.ClientBase<DMS_DOCUMENT_SERVICE.AddDocument>, DMS_DOCUMENT_SERVICE.AddDocument
    {
    ...
    static partial void ConfigureEndpoint(System.ServiceModel.Description.ServiceEndpoint serviceEndpoint, System.ServiceModel.Description.ClientCredentials clientCredentials);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<DMS_DOCUMENT_SERVICE.addDocumentResponse> DMS_DOCUMENT_SERVICE.AddDocument.addDocumentAsync(DMS_DOCUMENT_SERVICE.addDocumentRequest request)
        {
            return base.Channel.addDocumentAsync(request);
        }
        
        public System.Threading.Tasks.Task<DMS_DOCUMENT_SERVICE.addDocumentResponse> addDocumentAsync(string mahindraAction, string documentType, string userName, string[] propsLableValueArray, string fileExt, byte[] docObjArry)
        {
            DMS_DOCUMENT_SERVICE.addDocumentRequest inValue = new DMS_DOCUMENT_SERVICE.addDocumentRequest();
            ...
            return ((DMS_DOCUMENT_SERVICE.AddDocument)(this)).addDocumentAsync(inValue);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.AddDocument))
            {
                return new System.ServiceModel.EndpointAddress("http://mfdms.com/Webservice/AddDocument.jws");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
